...
export const ROLE_CONFIG: Record<RoleCode, RoleConfiguration> = {
  ...
  [RoleCode.SYSTEM_ADMIN]: {
    // Keep the persisted role code; grant capabilities through the same guards as every role.
    // Explicit grants make new permissions a reviewed policy change, not an authorization bypass.
    label: "최고관리자",
