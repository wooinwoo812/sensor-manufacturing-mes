...
> 센서 제조의 생산·자재·품질·LOT 이력을 하나의 흐름으로 연결하는 웹 기반 MES 포트폴리오
...
이 프로젝트는 특정 회사의 내부 MES를 복제하지 않습니다. 공개된 제조·채용 정보에서 문제 영역만 참고했으며 회사명, 로고, 고객, 실제 공정조건, 품질 기준 및 운영 데이터는 사용하지 않습니다. 화면과 데이터는 모두 가상입니다.
